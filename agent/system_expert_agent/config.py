...
# the desktop app's own chat.sqlite (crates/system-expert-core) since that's the transcript the UI
...
SYSTEM_PROMPT = """You are System-Expert's built-in assistant, embedded in a desktop system monitor \
