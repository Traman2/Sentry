...
/** Mirrors `crates/system-expert-core/src/chat/mod.rs::ChatSpace`. */
...
/** Mirrors `crates/system-expert-core/src/chat/mod.rs::ChatMessage`. */
...
/** Mirrors `crates/system-expert-core/src/chat/mod.rs::ChatSpaceDetail`. */
