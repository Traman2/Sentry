 ...
 * `crates/system-expert-core/src/monitor/*.rs`. Kept in sync by hand — if you add or
...
/**
 * Mirrors `crates/system-expert-core/src/history/query.rs`. One row recorded roughly every
 * 2 seconds by the background history recorder (`system_expert_core::spawn_recorder`),
...
/**
 * Mirrors `crates/system-expert-core/src/monitor/process.rs::KillOutcome`.
 *
...
/** Mirrors `crates/system-expert-core/src/tracking/models.rs::TrackedProcess`. */
...
/** Mirrors `crates/system-expert-core/src/tracking/models.rs::TrackedArchive`. */
